...
internal protocol NetworkRequest: Encodable {
    ...
    /// Indicates if request requires authorization
...
internal extension NetworkRequest {
    ...
    var networkApplication: NetworkApplication {
        #if ENV_PRODUCTION || ENV_RELEASE
            return ProductionNetworkApplication()
        #else
            return StagingNetworkApplication()
        #endif
    }
